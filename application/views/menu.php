...
<ul>
   ...
   <li class="has-sub"><a href='#'>Master</a><ul><li class="has-sub"><a href='<?php echo site_url();?>/master_pegawai/c_tampil_pegawai'>Pegawai</a></li><li class="has-sub"><a href='<?php echo site_url();?>/master_barang/c_tampil_barang'>Barang</a><ul><li><a href='<?php echo site_url();?>/master_barang/c_tampil_jenis_barang'>jenis barang</a></li><li><a href="<?php echo site_url();?>/master_barang/c_tampil_stock_barang">stock barang</a></li></ul></li><li><a href="<?php echo site_url(); ?>/master_mesin/c_tampil_mesin">Mesin</a></li><li class="has-sub"><a href='<?php echo site_url();?>/master_mesin/c_kapasitas'>kapasitas</a></li><li><a href='<?php echo site_url();?>/master_pelanggan/c_tampil_pelanggan'>Pelanggan</a></li><li><a href='<?php echo site_url();?>/master_pesanan_pelanggan/c_tampil_pesanan'>Pesanan pelanggan</a></li></ul></li>
